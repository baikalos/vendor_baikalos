...
$(TARGET_GENERATED_BOOTANIMATION): $(SOONG_ZIP)
	...
	@rm -rf $(dir $@)
	@mkdir -p $(dir $@)
	$(hide) tar xfp vendor/baiklaos/bootanimation/bootanimation$(shell shuf -i 0-3 -n 1).tar -C $(INTERMEDIATES)
	...
	cat vendor/baiklaos/bootanimation/desc.txt >> $(INTERMEDIATES)/desc.txt

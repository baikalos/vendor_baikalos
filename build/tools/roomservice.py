...
DEBUG = False
default_manifest = ".repo/manifests/baikalos_default.xml"
custom_local_manifest = ".repo/local_manifests/baikalos_manifest.xml"
custom_default_revision = "8.1"
custom_dependencies = "baikalos.dependencies"
org_manifest = "baikalos-Devices"  # leave empty if org is provided in manifest
org_display = "baikalos-Devices"  # needed for displaying

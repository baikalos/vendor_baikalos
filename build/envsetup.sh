...
- baikalosrebase:   Rebase a Gerrit change and push it again.
- baikalosremote:   Add git remote for baikalos Gerrit Review.
...
function baikalosgerrit() {
    ...
    local user=`git config --get review.gerrit.baikalos.username`
...
function rebase() {
    ...
    if [ -z $repo ] || [ -z $refs ]; then
        ...
        echo "      rebase <path to project> <patch IDs on Gerrit>"
